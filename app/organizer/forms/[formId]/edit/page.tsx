...
export default function EditOrganizerFormPage() {
  ...
  const [pageFields, setPageFields] = useState<Record<number, any[]>>({
    1: DEFAULT_FIELDS,
  });
        ...
        <div className="w-full max-w-[1040px] flex flex-col gap-[24px]">
          ...
          {activePage === 1 && (
            <>
                    ...
                    {ifYesOpen && (
                      <div className="px-[20px] pb-[28px] flex flex-col gap-[24px] border-t border-[#F3F3F3]">
                        ...
                        <p className="text-[13px] text-[#C0BDB4]">
                          Please fill in the application jointly and as
              ...
              <div className="grid grid-cols-2 gap-[24px]">
                {["First-Choice Option", "Second-Choice Option"].map(
                  (label) => (
              ...
              <div className="grid grid-cols-2 gap-[24px]">
                <div className="flex flex-col gap-[8px]">
                  ...
                  <div className="relative">
                    <input
                      type="date"
                      className="w-full h-[48px] rounded-[10px] border border-[#E9E9E9] bg-white px-[14px] text-[14px] text-[#262626] outline-none focus:border-[#C0BDB4]"
                    />
                    <svg
                      className="absolute right-[14px] top-1/2 -translate-y-1/2 pointer-events-none"
                      width="16"
              ...
              <div className="flex flex-col gap-[12px]">
                <p className="text-[14px] text-[#262626]">
                  ...
                  <span className="font-medium">(add link to text)</span> of
                  Event Name. <span className="text-[#C0BDB4]">*</span>
                </p>
              ...
              <button
                onClick={() => {
                  const newField = {
                    ...
                    type: "short_text",
                    label: "Question",
                    field_key: `question_p${activePage}_${Date.now()}`,
                    required: true,
                    placeholder: "",
                    options: [],
                    sortOrder: (pageFields[activePage] ?? []).length,
                  };
                  setPageFields((prev) => ({
                    ...prev,
                    [activePage]: [...(prev[activePage] ?? []), newField],
                  }));
                }}
