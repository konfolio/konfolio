...
export default function PublishMissingFieldsPopover({
  ...
  const buttonsJustify = isOptionalOnlyMode
    ? "justify-between"
    : "justify-center";
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      >
          ...
          {hasRequired ? (
            <div className="flex flex-col gap-[10px]">
              {allRequired.map((item) => (
                <div
                  key={`req-${item}`}
                  className="text-[15px] leading-[150%] text-center text-[#FF4603]"
                >
                  {item}
                </div>
              ))}
        ...
        {isOptionalOnlyMode ? (
          <div
            className="mt-[50px] text-[15px] leading-[150%] text-center text-[#262626]"
            style={{ width: 538 }}
          >
        ...
        >
          {isOptionalOnlyMode ? (
            <SecondaryButton onClick={() => onPublishAnyway?.()}>
              Publish
            </SecondaryButton>
          ) : null}
          ...
          <div
            ...
            style={{ width: isOptionalOnlyMode ? 150 : 163 }}
          >
            <PrimaryButton
              href="#"
              icon="none"
