          ...
          <div className="mx-auto max-w-[1512px]">
            <div className="flex flex-col items-center">
              <EditPortraitProfile
                ...
                onChangeLinks={(next) => patchDraft(draftId, { links: next } as any)}
                merchTags={draft.merchTags}
                onChangeMerchTags={(next) => patchDraft(draftId, { merchTags: next } as any)}
              ...
              <EditPortraitImageGrid
                ...
                onChangePreviousVends={(vals) => patchDraft(draftId, { previousVends: vals } as any)}
              />
            </div>
          </div>
        </div>
